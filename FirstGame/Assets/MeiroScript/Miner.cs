...
public class Miner : MonoBehaviour
{
    ...
    IEnumerator Mining(int ver, int hor)
    {
        ...
        float random1 = Random.Range(0.01f, 1.5f);
        ...
        if (upObj != null)
        {
            ...
            //新たなMinerを生成
            GameObject minerObj = Instantiate(m_miner, Vector2.zero, Quaternion.identity);
            //新たなMinerのスクリプトを取得
        ...
        float random2 = Random.Range(0.01f, 1.5f);
        ...
        float random3 = Random.Range(0.01f, 1.5f);
        ...
        float random4 = Random.Range(0.01f, 1.5f);
